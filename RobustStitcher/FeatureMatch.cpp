...
void calib::FeatureMatch::current_feature_thread_(cv::Mat& src, cv::Mat& img, calib::Imagefeature& feature,
													calib::Imagefeature& current_feature, calib::Matchesinfo& matchesinfo,int i)
{
	...
	surf_d2.downloadKeypoints(keypoints_2, feature.keypt);
	descriptors_2.download(feature.des);
